...
class Musics {
    ...
    constructor() {
        this.songs = [{
                ...
                singer: 'The Kid LAROI,Justin Bieber - STAY',
                songUrl: './songs/The Kid LAROI,Justin Bieber - STAY.mp3',
                imageUrl: './images/songs/Stay.jpg'
            },
            {
                id: 2,
                title: 'Taylor Swift - Love Story',
                singer: 'Taylor Swift - Love Story',
                songUrl: './songs/Taylor Swift - Love Story.mp3',
                imageUrl: './images/songs/Love.jpg'
            },
            {
                id: 3,
                title: 'JVKE - golden hour',
                singer: 'JVKE - golden hour',
                songUrl: './songs/JVKE - golden hour.mp3',
                imageUrl: './images/songs/golden.jpg'
            },
            {
                id: 4,
                title: '刘昊霖,kidult. - Landing Guy',
                singer: '刘昊霖,kidult. - Landing Guy',
                songUrl: './songs/刘昊霖,kidult. - Landing Guy.mp3',
                imageUrl: './images/songs/Landing.jpg'
            }
        ]
    }
    //根据索引获取歌曲的方法
